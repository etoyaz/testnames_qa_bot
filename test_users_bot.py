...
TOKEN = '5972686759:AAHqnVh5Zr1cDcWruPu2iqVWZKDTLYPkAiI'
...
def start_message_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        "Пожалуйста, выбери количество тестовых пользователей, которое необходимо сгенерировать 👇🏻",
...
def message_handler(message: types.Message):
    ...
    if message.text == "1️⃣":
        ...
        bot.send_message(chat_id=message.chat.id, text="Не понимаю:(  Попробуешь еще разок?")
        return
